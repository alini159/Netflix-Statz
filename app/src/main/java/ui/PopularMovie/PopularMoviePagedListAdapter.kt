...
class PopularMoviePagedListAdapter(public val context: Context, val userId: String) : PagedListAdapter<Movie, RecyclerView.ViewHolder>(MovieDiffCallback()) {
    ...
    fun searchMovie(holder: PagedList<Movie>, movie: Int){
